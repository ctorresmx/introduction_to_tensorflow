...
class App(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.load_model('{}/mnist_trained.meta'.format(model_directory))
    ...
    def load_model(self, model_path, latest_checkpoint=model_directory):
        ...
        saver.restore(
            ...
            tf.train.latest_checkpoint(latest_checkpoint)
        )
        ...
        self.predict = self.graph.get_tensor_by_name('prediction:0')
